...
المخرجات في مجلد `dorar_tafseer_output/` مقسّمة إلى ثلاثة فروع:
...
| `surah_index/` | ملف **تعريفي** لكل سورة يحتوي صفحتها الأولى كاملة (الأسماء، الفضائل، المقاصد، الموضوعات) |
